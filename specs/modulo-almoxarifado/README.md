...
> **Última atualização:** 2026-08-28 (**Etapa 16 fechada — alertas operacionais, a fatia
...
| 20 | [Alertas operacionais](20-alertas/README.md) | 🟢 | 🟢 | ✅ | 🟡-forte **13 de 20 (Etapa 16 somou 7 — `6bed5e2..ed5f032`)** — registro único `alertRegistry` (varredura diária pela fila da 19, e-mail e central leem a MESMA lista; erro num alerta não cala os demais, testado nos dois lados), central `/almoxarifado/alertas` ao vivo gateada por `ver_alertas` (B28), 3 janelas configuráveis nos dois lados. Dois itens SAÍRAM do checklist dizendo por quê (transferência: CORTADA pelo cliente; negativo: regra do motor). Falta, nomeado: 4 alertas de evento (reprovado, divergências de recebimento/inventário, sem certificado — gancho no ato) e 3 com lacuna de dado nas features donas (data da transição p/ retirada, saldo de pedido, orçamento de projeto); canal/destinatário por alerta segue corte da 12 (B15) |

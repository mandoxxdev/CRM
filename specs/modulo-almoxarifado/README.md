...
> **Última atualização:** 2026-08-28 (**Etapa 21 fechada — exposição no NÚCLEO do CRM,
...
> webhook em claro com o token dentro. **Fica declarado:** a trilha segue sem tela (B33), o
> volume do log de permissões (~46 KB/save, G8) e o ato parcial sem rastro.

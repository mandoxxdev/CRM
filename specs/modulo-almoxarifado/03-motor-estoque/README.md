...
> **Última atualização:** 2026-08-09 (Etapa 6, Task 3, round 5 do review — o discriminador do estorno passa a ser "o material já tem linha?"; mais as correções do round 4: mapa mostra material sem endereço, e a afirmação errada desta spec sobre a invariante da linha de saldo)

...
function getClausulasDefault() {
  return [
    ...
    },
    {
      ...
      conteudo: '<p>Estão exclusos do fornecimento da CONTRATADA, ficando sob responsabilidade da CONTRATANTE, salvo menção expressa em contrário nesta proposta:</p><ol style="padding-left:25px;"><li>Transporte, frete e seguro dos equipamentos e suas partes, incluindo coletas, entregas intermediárias, içamentos e armazenagens externas;</li><li>Movimentação e içamento: munck, guindaste, empilhadeira, pórtico, talha, plataforma elevatória, rigging e amarração de carga;</li><li>Serviços, materiais e infraestrutura de instalação: elétrica, hidráulica, pneumática, civil, alvenaria, serralheria, tubulação, isolamento, pintura, drenagem, exaustão e ventilação;</li><li>Obras civis e adequações estruturais: fundações, pisos, reforços, aberturas, demolições, suportes, chumbadores, mezaninos, plataformas, escadas e guarda-corpos;</li><li>Translado, hospedagem, alimentação e logística da equipe técnica em montagem, comissionamento, startup, assistência técnica, treinamento e visitas técnicas;</li><li>Sapatas, brocas, bases, reforços e elementos de fixação estrutural para instalação, ancoragem e nivelamento;</li><li>Consultoria química, industrial, de processo, regulatória ou ambiental, incluindo licenças, alvarás e aprovações junto a órgãos públicos, concessionárias e certificadoras;</li><li>Laudos, certificados, ensaios e calibrações especiais (RBC, ISO, organismos acreditados, aferições, inspeções por terceiros e validações) não previstos no escopo;</li><li>Equipamentos e periféricos complementares: compressor de ar, exaustores, torre de resfriamento, Chiller, bombas, tachos, tanques, reservatórios, balanças, envasadoras e válvulas;</li><li>Consumíveis e utilidades operacionais: energia elétrica, água, ar comprimido, vapor, fluido térmico, óleo, combustível, produtos de limpeza, matéria-prima e produto para testes;</li><li>Mão de obra de terceiros: eletricistas, encanadores, soldadores, montadores, pedreiros, operadores de empilhadeira, riggers e técnicos de automação;</li><li>Adequações normativas do local: NR-10, NR-12, NR-13, AVCB, combate a incêndio, aterramento, SPDA, enclausuramento, proteção coletiva e sinalização;</li><li>Manutenção preventiva, corretiva ou preditiva e reposição de peças por desgaste natural, salvo o coberto pela garantia;</li><li>Custos de paralisações, improdutividade, perdas de produção ou receitas, lucros cessantes e danos indiretos;</li><li>Quaisquer outros itens, serviços, materiais, documentos ou adequações não citados expressamente nesta proposta como responsabilidade da CONTRATADA.</li></ol>'
    },

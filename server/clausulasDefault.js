 ...
 * A cláusula 5.23 (Preço/Pagamento) é dinâmica e excluída daqui — gerada separadamente.
 */
function getClausulasDefault() {
  return [
    ...
    },
    {
      numero: '5.21',
      titulo: 'FORO',
      conteudo: '<p>As partes elegem o Foro da Comarca de Diadema - SP, para qualquer ação, processo ou litígio oriundo da responsabilidade pelos produtos e/ou serviços fornecidos conforme ESCOPO DE FORNECIMENTO deste contrato, com renúncia de qualquer outro por mais especial que seja.</p>'
    },
    {
      numero: '5.22',
